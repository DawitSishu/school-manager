...
function SignUpForm(props) {
  ...
  return (
    ...
    >
      <Typography variant="h5" align="center">Create a New Account</Typography>
      <br />
          ...
          <Autocomplete
            ...
            renderOption={(props, option, { selected }) => (
              <MenuItem {...props} key={option} value={option}>
                {option}
                {selected ? <Box component="span" color="info.main">&#10003;</Box> : null}
              </MenuItem>
            )}
          />
        )}
      />
      {errors.subjects && <Typography variant="h7" color="red">{errors.subjects.message}</Typography>}
      <br />
        </>
      ) : (
        selectedValue === "student" && (
          <>
            ...
            />
             {errors.birth_date && <Typography variant="h7" color="red">{errors.birth_date.message}</Typography>}
      <br />
      <br />
          </>
        )
      ...
      <br />
      {errors.email && (
        <Typography variant="h7" color="red">{errors.email.message}</Typography>
      )}
      <br />
      <OutlinedInput
        sx={{
      ...
      <br />
      {errors.password && (
        <Typography variant="h7" color="red">{errors.password.message}</Typography>
      )}
      <br />
